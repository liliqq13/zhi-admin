'use strict';
const ASSETS = ["./app-config.js", "./app-runtime.js", "./app.css", "./assets/image-2654e9a5ca837084.jpg", "./assets/image-3110ecdd94c95c5a.jpg", "./assets/image-3ce18f33a4d56653.jpg", "./assets/image-4d7a8ae9ef298d1e.jpg", "./assets/image-5b696b84e0353ced.jpg", "./assets/image-65a005139f06da87.jpg", "./assets/image-79c29d2f1f1ea316.webp", "./assets/image-9d4de02ab9709bf6.webp", "./assets/image-a8ea88a71894cc41.jpg", "./assets/image-e07c02e6963602b6.jpg", "./assets/image-f2126a69d5e3c3ec.jpg", "./assets/image-f90aea4de23c6c67.jpg", "./assets/image-fbdf9a00a12f9045.webp", "./icons/apple-touch-icon.png", "./icons/icon-192.png", "./icons/icon-512.png", "./icons/icon-maskable-512.png", "./index.html", "./manifest.webmanifest"];
const PREFIX = 'zls-app-shell-' + encodeURIComponent(new URL(self.registration.scope).pathname) + ':';
const CACHE = PREFIX + 'dee60f800f7c4b92';
const base = new URL(self.registration.scope);
const assetURLs = new Set(ASSETS.map(path => new URL(path, base).href));
self.addEventListener('install', event => {
  event.waitUntil(caches.open(CACHE).then(cache => cache.addAll(ASSETS.map(path => new URL(path, base).href))));
});
